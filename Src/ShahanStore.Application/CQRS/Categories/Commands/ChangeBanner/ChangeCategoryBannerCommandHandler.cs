...
{
    public async Task<OperationResult<string?>> Handle(ChangeCategoryBannerCommand request, CancellationToken cancellationToken)
    {
        ...
        string? oldBannerImage= category.BannerImg;
